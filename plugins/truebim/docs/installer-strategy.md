...
```text
C:\ProgramData\Autodesk\Revit\Addins\2025\TrueBIM.addin
```
...
Initial recommendation: current-user install while developing, all-users install later when packaging is stable.
