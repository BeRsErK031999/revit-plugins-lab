...
9. Правила армирования рассчитываются в read-only режиме и показывают диагностику.
10. Пробное армирование создаётся только по кнопке `Создать пробное армирование` и после явного подтверждения.
...
9. Нажмите `Рассчитать правила` и проверьте список правил и диагностику.
10. Нажмите `Создать пробное армирование` только если правила валидны и вы готовы изменить модель.
11. После проверки созданного пробного элемента выполните Revit Undo.
...
- Overlay и managed-модель читают верхнюю грань простой горизонтальной плиты и отсекают зоны с учётом отверстий. Пробные стержни по-прежнему размещаются упрощённо по bounding box и ещё не используют регионы отсечения.
