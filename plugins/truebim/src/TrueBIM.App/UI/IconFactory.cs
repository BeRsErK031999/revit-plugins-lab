...
internal static class IconFactory
{
    ...
    private static string GetGeometry(TrueBimIcon icon)
    {
        return icon switch
        {
            ...
            TrueBimIcon.ScheduleRegister => "M1.5,2 L14.5,2 L14.5,14 L1.5,14 Z M2.8,4 L13.2,4 L13.2,5.2 L2.8,5.2 Z M2.8,6.5 L5,6.5 L5,8 L2.8,8 Z M6,6.5 L13.2,6.5 L13.2,8 L6,8 Z M2.8,9.2 L5,9.2 L5,10.7 L2.8,10.7 Z M6,9.2 L13.2,9.2 L13.2,10.7 L6,10.7 Z M2.8,11.9 L5,11.9 L5,13 L2.8,13 Z M6,11.9 L11,11.9 L11,13 L6,13 Z M12,11.2 L15.2,11.2 L15.2,10 L16.5,12 L15.2,14 L15.2,12.8 L12,12.8 Z",
            ...
            TrueBimIcon.SharedParameters => "M2,2 L6.5,2 L6.5,3.5 L14,3.5 L14,5 L6.5,5 L6.5,6.5 L2,6.5 Z M3.5,3.5 L5,3.5 L5,5 L3.5,5 Z M9.5,7.5 L14,7.5 L14,9 L9.5,9 L9.5,10.5 L2,10.5 L2,9 L9.5,9 Z M11,9 L12.5,9 L12.5,10.5 L11,10.5 Z M2,12 L6.5,12 L6.5,13.5 L14,13.5 L14,15 L6.5,15 L6.5,16.5 L2,16.5 Z M3.5,13.5 L5,13.5 L5,15 L3.5,15 Z",
            ...
            TrueBimIcon.Copy => "M2,2 L10,2 L10,4 L4,4 L4,11 L2,11 Z M5,5 L12,5 L14,7 L14,14 L5,14 Z M12,5 L12,7 L14,7 Z",
            TrueBimIcon.Delete => "M4,4 L12,4 L11.4,14 L4.6,14 Z M3,2.5 L6,2.5 L6,1.5 L10,1.5 L10,2.5 L13,2.5 L13,4 L3,4 Z M6,6 L7.2,6 L7.2,12 L6,12 Z M8.8,6 L10,6 L10,12 L8.8,12 Z",
