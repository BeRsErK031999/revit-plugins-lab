...
public sealed class FinishScheduleGuideWindow : TrueBimWindow
{
    ...
    private static UIElement CreateGuideBody()
    {
        ...
        body.Children.Add(CreateSection(
            ...
            CreateNumberedList(
                ...
                "Плагин сначала зафиксирует текущие данные прежних ведомостей TrueBIM, затем запишет изменившиеся выходные параметры и создаст новую версию. При включённом флажке также обновится принадлежность элементов.",
    ...
    private static UIElement CreateDataFlowTable()
    {
        ...
        rows.Children.Add(CreateDataFlowRow(
            ...
            "Новая версия ведомости с зафиксированными данными; прежние версии сохраняются.",
            isLast: true));
        return CreateTableFrame(rows);
    }
