...
public static class FinishScheduleDiagnosticGuidanceBuilder
{
        ...
        IReadOnlyList<FinishGeometryWarning> warnings)
    {
        ...
        guidance.Add(category == FinishPreviewCategory.Ceilings
            ? "Для потолков проверьте верхнюю границу помещений, горизонтальность элементов и отсутствие изменения формы. Сложные потолки разделите на простые горизонтальные участки или отключите категорию для этого расчёта."
