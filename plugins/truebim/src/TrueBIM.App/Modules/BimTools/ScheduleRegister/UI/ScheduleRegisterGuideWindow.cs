...
public sealed class ScheduleRegisterGuideWindow : TrueBimWindow
{
    ...
    [
        (
            "Быстрый сценарий",
            [
                "Откройте «Ведомость спецификаций». В списке доступны все обычные листы проекта.",
                "Снимите галочки с лишних листов. По умолчанию отмечены все листы; если перед запуском листы выделены в диспетчере проекта, отмечены только они.",
                "Кнопка «Выбрать со спецификациями» отмечает найденные листы с размещёнными спецификациями и снимает все остальные галочки. Список при этом не скрывается.",
                "Поиск сохраняет галочки на скрытых строках. «Выбрать найденные» добавляет найденные листы к выбору, а «Снять выбор» снимает все галочки.",
                "Фильтр и шаблон настраиваются кнопкой «Настройки» в этом окне. Проверьте готовность значком рядом с поиском и нажмите «Создать ведомость».",
        ...
        (
            ...
            [
                ...
                "Выбор листов и фильтр работают вместе: галочки задают листы, а параметр исключает отдельные спецификации на них.",
                "Количество в столбце «Размещено спецификаций» и кнопка выбора учитывают размещения до применения фильтра по параметру.",
