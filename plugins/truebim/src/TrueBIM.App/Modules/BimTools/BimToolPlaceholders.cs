...
public static class BimToolPlaceholders
{
    ...
    public static BimToolPlaceholderDefinition ClashReport { get; } = new(
        ...
        "Каркас инструмента для будущего импорта коллизий и навигации по ним в Revit.",
        [
            "Импорт CSV с ElementId и координатами.",
        ...
        [
            "Начать с CSV, HTML Navisworks отложить.",
            "Разрешать элементы по ElementId с отметкой unresolved.",
