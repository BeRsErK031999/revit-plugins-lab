...
public static class TrueBimRibbon
{
    ...
    [
        ...
        new(
            ...
            "Открывает понятное окно выбора листов и создаёт по ним ведомость спецификаций.",
            "Отметьте листы в окне команды, проверьте состояние шаблона и нажмите «Создать ведомость». TrueBIM прочитает названия из первой строки шапки, объединит сегменты и заполнит новую копию шаблона."),
        new(
            BimDocumentationPanelName,
