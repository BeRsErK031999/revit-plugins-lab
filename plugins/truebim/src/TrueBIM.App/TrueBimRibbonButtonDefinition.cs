...
public static class TrueBimRibbon
{
    ...
    [
        ...
        new(
            ...
            "Создаёт ведомость по листам, выбранным в диспетчере проекта.",
            "Сначала выделите листы в диспетчере проекта, затем запустите команду, проверьте список и нажмите «Создать ведомость». TrueBIM прочитает названия из первой строки шапки, объединит сегменты и заполнит новую копию шаблона."),
        new(
            BimDocumentationPanelName,
