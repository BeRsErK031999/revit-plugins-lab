...
$trueBim2023Root = Join-Path $trueBimRoot "2023"
$addinRoot = Join-Path $env:APPDATA "Autodesk\Revit\Addins\2023"
$addinPath = Join-Path $addinRoot "TrueBIM.addin"
$corePath = Join-Path $trueBim2023Root "Core"
$modulesPath = Join-Path $trueBim2023Root "Modules"
$assetsPath = Join-Path $trueBim2023Root "Assets"
$settingsPath = Join-Path $trueBim2023Root "module-settings.json"
