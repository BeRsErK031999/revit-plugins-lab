...
$trueBim2026Root = Join-Path $trueBimRoot "2026"
$addinRoot = Join-Path $env:APPDATA "Autodesk\Revit\Addins\2026"
$addinPath = Join-Path $addinRoot "TrueBIM.addin"
$corePath = Join-Path $trueBim2026Root "Core"
$modulesPath = Join-Path $trueBim2026Root "Modules"
$assetsPath = Join-Path $trueBim2026Root "Assets"
$docsPath = Join-Path $trueBim2026Root "Docs"
$settingsPath = Join-Path $trueBim2026Root "module-settings.json"
...
Remove-SafePath -Path $docsPath -AllowedRoots @($trueBimRoot)
