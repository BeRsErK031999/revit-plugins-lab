...
$sheetNumberingPath = Join-Path $trueBim2022Root "Modules\SheetNumbering"
$scheduleColumnCollapsePath = Join-Path $trueBim2022Root "Modules\ScheduleColumnCollapse"
