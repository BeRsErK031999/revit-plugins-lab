...
- Единое окно для PDF, DWG, DXF и DWF: нужные форматы отмечаются в нижней панели, подробные параметры раскрываются кнопкой `Настройки...`.
