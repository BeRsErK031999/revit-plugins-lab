...
[Setup]
AppId={{8F8E8CC7-D3C9-49BA-8F40-AD0F2F8D32F7}-2022
AppName={#AppName} for Revit 2022
AppVersion={#AppVersion}
AppPublisher={#Publisher}
DefaultDirName={userappdata}\TrueBIM\2022
DefaultGroupName=TrueBIM
OutputBaseFilename=TrueBIM-Setup-2022
Compression=lzma
...
Source: "..\artifacts-2022\Docs\*"; DestDir: "{app}\Docs"; Components: docs; Flags: ignoreversion recursesubdirs createallsubdirs

[Icons]
Name: "{group}\TrueBIM Revit 2022 Documentation"; Filename: "{app}\Docs\README.md"; Components: docs

[Run]
Filename: "{cmd}"; Parameters: "/c echo TrueBIM for Revit 2022 installed"; Flags: runhidden; Components: core
...
begin
  ...
  begin
    ManifestPath := ExpandConstant('{userappdata}\Autodesk\Revit\Addins\2022\TrueBIM.addin');
